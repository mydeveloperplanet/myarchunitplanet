package com.mydeveloperplanet.myarchunitplanet.example5.controller;

import java.util.List;
import java.util.Optional;

import com.mydeveloperplanet.myarchunitplanet.example5.model.Customer;
import com.mydeveloperplanet.myarchunitplanet.example5.service.CustomerServiceInterface;
...
class CustomersController implements CustomersApi {
    ...
    public CustomersController(CustomerServiceInterface customerService) {
